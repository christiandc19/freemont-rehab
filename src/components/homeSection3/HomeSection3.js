      ...
      <div className="homeSection3">
        <div className="homeSection3-content container">
          ...
          <p>
            ...
            transportation, yoga, and more. We offer support that clients need
          ...
          <div className="homeSection3-cards">
            <div className="homeSection3-item">
              ...
              <p>
                ...
                situations. Fast heart rate, rapid breathing, sweating, and
            ...
            <div className="homeSection3-item">
              ...
              <h1>DEPRESSION</h1>
              <p>
                A group of conditions associated with the elevation or lowering
                of a person's mood, such as depression or bipolar disorder.
              </p>
              <br />
              <LinkRoll
                activeClass="active"
            ...
            <div className="homeSection3-item">
              ...
              <h1>BIPOLAR</h1>
              <p>
                The exact cause of bipolar disorder isn’t known, but a
            ...
            <div className="homeSection3-item">
              ...
              <p>
                {" "}
                It is a state of worry or mental tension caused by a difficult
            ...
            <div className="homeSection3-item">
              ...
              <p>
                It is a recurring and regular panic attacks, often for no
                apparent reason. Everyone experiences feelings of anxiety and
                panic at certain times during their lifetime.
              </p>
              <br />
              <LinkRoll
                activeClass="active"
            ...
            <div className="homeSection3-item">
              ...
              <h1>SCHIZOPHRENIA</h1>
              <p>
                Paranoid delusions, also called delusions of persecution,
                reflect profound fear and anxiety along with the loss of the
                ability to tell what's real and what's not real.{" "}
              </p>
              <br />
              <LinkRoll
                activeClass="active"
