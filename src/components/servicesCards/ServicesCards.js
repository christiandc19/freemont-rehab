      ...
      <div className="cards2main-container">
        ...
        <div className="cards2-header container">
          ...
          <div className="header-right">
            <p>
              At <span>Fremont Rehab Treatment Center,</span> clients receive
              individual therapy alongside a range of additional treatments,
              including relapse prevention, trauma therapy, mindfulness
              meditation, transportation, yoga, and more. We offer support that
              clients need to allow them to gradually go back to treatment.{" "}
            </p>
          </div>
        </div>
          ...
          <Fade left>
            <div className="drop drop1">
              <div className="content">
                ...
                <p>
                  Some of our clients are here to attend to their mental health,
                  and some come to us for help with addiction and sobriety.
                </p>
                <LinkRoll
                  activeClass="active"
                  to="top"
