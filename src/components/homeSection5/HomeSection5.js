        ...
        <div className="homeSection5-content container">
          ...
          <div className="homeSection5-cards">
            ...
            <div className="homeSection5-item">
              ...
              <h1>ALCOHOLISM</h1>
              <p>
                A chronic disease characterized by uncontrolled drinking and
            ...
            <div className="homeSection5-item">
              ...
              <p>
                Cocaine is a powerfully addictive stimulant drug that comes in
                the form of a white powder which is commonly snorted, smoked, or
                injected.
              </p>
              <br />
              <LinkRoll
            ...
            <div className="homeSection5-item">
              ...
              <p>
                ...
                Specifically, heroin is produced from morphine, which is a
                principal component of opium.
              </p>
              <br />
              <LinkRoll
                activeClass="active"
