...
<div className="sa-cards-header container">
                <h1>FREEMONT REHAB OFFERS VARIOUS SUBSTANCE ABUSE PROGRAMS </h1>
...
<img src={Card2} alt="Substance Use" loading="lazy"/>
  ...
  <p class="sa-animate-text">No matter what type of addiction or mental health condition you are dealing with, there’s something for everyone at Freemont Rehab.</p>
  <div class="sa-animate-text">
    <LinkRoll activeClass="active" to="top" spy={true} smooth={true} duration={500}>
