      ...
      <div className="wrap">
        <Fade left>
          <div className="box-left">
            <div className="left-description">
              ...
              <br />
              <p>
                At Fremont Rehab Treatment Center, we offer different levels of
                care based on each individual’s needs. Our programs consist of
        ...
        <Fade right>
          <div className="box-right">
            <img
              src={WhatWeDoImg}
              alt="Conselling Session with a patient"
              loading="lazy"
            />
          </div>
